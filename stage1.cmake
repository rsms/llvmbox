...
# get_filename_component(LLVMBOX_BUILD_DIR "${CMAKE_CURRENT_BINARY_DIR}/.." ABSOLUTE)
...
set(HAVE_POSIX_REGEX 1 CACHE BOOL "")
set(HAVE_STEADY_CLOCK 1 CACHE BOOL "")
...
set(LLVM_ENABLE_PYTHON OFF CACHE BOOL "")
...
set(LLVM_TABLEGEN "${LLVM_STAGE1}/bin/llvm-tblgen" CACHE STRING "")
set(CLANG_TABLEGEN "${LLVM_STAGE1}/bin/clang-tblgen" CACHE STRING "")
...
if(WIN32)
  ...
  set(RUNTIMES_CMAKE_ARGS "-DCMAKE_OSX_DEPLOYMENT_TARGET=${CMAKE_OSX_DEPLOYMENT_TARGET};-DCMAKE_OSX_ARCHITECTURES=arm64|x86_64" CACHE STRING "")
endif()
...
if(BOOTSTRAP_CMAKE_SYSTEM_NAME)
  ...
  if(STAGE2_LINUX_${target}_SYSROOT)
    ...
    set(RUNTIMES_${target}_LIBCXX_ABI_VERSION 1 CACHE STRING "")
