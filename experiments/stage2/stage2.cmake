...
set(EXTRA_LDFLAGS "")
if(NOT APPLE)
  set(EXTRA_LDFLAGS "-static")
  list(APPEND CMAKE_EXE_LINKER_FLAGS "-static")
  list(APPEND BOOTSTRAP_CMAKE_EXE_LINKER_FLAGS "-static")
endif()
...
foreach(target aarch64-unknown-linux-gnu;armv7-unknown-linux-gnueabihf;i386-unknown-linux-gnu;x86_64-unknown-linux-gnu)
  if(LINUX_${target}_SYSROOT)
    ...
    set(BUILTINS_${target}_CMAKE_EXE_LINKER_FLAG "-fuse-ld=lld ${EXTRA_LDFLAGS}" CACHE STRING "")
    ...
    set(RUNTIMES_${target}_CMAKE_EXE_LINKER_FLAGS "-fuse-ld=lld ${EXTRA_LDFLAGS}" CACHE STRING "")
